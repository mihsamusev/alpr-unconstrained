...
if __name__ == '__main__':
    ...
    ag.add_argument("-i","--input" ,type=str, help="path to video")
    ag.add_argument("-o","--output" ,type=str, help="path to output frame folder")
    args = vars(ag.parse_args())
    # test it
    #video_to_frames(video_path='test.mp4', frames_dir='test_frames', overwrite=False, every=5, chunk_size=1000)
    video_to_frames(video_path=args["input"], frames_dir=args["output"], overwrite=True, every=1, chunk_size=1000)
